                            ...
                            <div className="flex-[2_2_0px] flex flex-col justify-between gap-6">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-bold">Google Sheets</h3>
                                            <p className="text-sm text-muted-foreground">
                                                Sincronização bidirecional de planilhas e documentos fiscais.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <CardContent className="p-5 flex flex-col gap-4">
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex flex-col items-end gap-2">
                                    <span className="bg-orange-100 text-orange-600 text-[10px] font-bold px-2 py-0.5 rounded">PREMIUM</span>
                                    <Switch
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground leading-snug mt-1">
                                    Sincronize suas planilhas automaticamente com o Google Drive.
                                </p>
                            </div>
                            <Button
                                variant="secondary"
                            ...
                            >
                                {isGoogleConnected ? "Gerenciar" : "Conectar"}
                            </Button>
                        </CardContent>
                    </Card>
